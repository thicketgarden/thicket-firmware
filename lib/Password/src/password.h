...
// also build this on the host for the vault tests, where that header does not
// exist. Nothing in this file referenced it.
#include <SHA256.h>
#include <CTR.h>
#include <AES.h>
// THICKET: dropped `#include <RNG.h>`. Salt and IV now come from
// RNS::Cryptography::random(), which is what the rest of this firmware uses
// and what works on both targets.
